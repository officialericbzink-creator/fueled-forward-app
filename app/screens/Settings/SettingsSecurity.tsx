...
interface SettingsMenuScreenProps extends SettingsStackScreenProps<"SettingsSecurity"> {}

export const SettingsSecurityScreen: FC<SettingsMenuScreenProps> = ({ navigation }) => {
